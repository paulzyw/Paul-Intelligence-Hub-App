...
export default function Galaxy({
  ...
  useEffect(() => {
    ...
    // Style the canvas to occupy the full container without taking up document flow space
    ...
    return () => {
      ...
      try {
        ...
        console.warn('Canvas removal failed or already removed', err);
      }
  ...
  return <div id="galaxy-canvas-container" ref={ctnDom} className={`w-full h-full ${className}`} {...rest} />;
}
