...
export function Theme() {
  return (
    <div className="flex flex-col w-full">
      ...
      <section className="relative w-full bg-bg-hero-primary py-24 lg:py-32 overflow-hidden flex items-center justify-center min-h-screen transition-colors duration-400">
